            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md border border-slate-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="document" name="document" type="text" value={formData.document || ''} onChange={handleChange} />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Select name="type_id" value={String(formData.type_id || '')} onValueChange={(value) => handleSelectChange('type_id', value)}>
                            <SelectTrigger>
                                <SelectValue placeholder="Selecciona un tipo" />
                            </SelectTrigger>
                            <SelectContent>
                                <SelectItem value="1">Prospecto</SelectItem>
